...
void stato(int posAttuale, int soldi, int prezzoPr, int numeroPro, int numCase, char citta[])
{
    int costoCasa = (prezzoPr * CASA) / 100;
    int costoCasaDue = (prezzoPr * CASADUE) / 100;
    ...
    printf("Costo proprietà: %d",prezzoPr);
