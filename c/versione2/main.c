    ...
    do
    {
        ...
        while (mosse > 0)
        {
            ...
            if (decisione == 1) // Sezione di movimento
            {
                ...
                if (temp >= PROPN)
                {
                    PassaDalVia(contoBancario);
                }
                if (temp == 3 || temp == 12)
                {
                    imprevisti(contoBancario);
                }
                if (temp == 7 || temp == 19)
                {
                    probabilita(contoBancario);
                }
            ...
            {
                pulisci();
                acquista(cellaAttuale, contoBancario, proprieties[cellaAttuale], prices[cellaAttuale], BoolComprata,numeroProprieta);
                mosse--;
                printf("                                                   \n");
                printf("                                                   \n");
                printf("Digitare qualunque numero per tornare al tabellone\n");
            ...
            else if (decisione == 3 && BoolComprata[cellaAttuale] == 1) // Sezione acquisto case
            {
                ...
                printf("                                                   \n");
                printf("                                                   \n");
                acquistoCasa(cellaAttuale, contoBancario, prices[cellaAttuale], proprieties[cellaAttuale],quantCase, numCase);
                printf("Digitare qualunque numero per tornare al tabellone\n");
                scanf("%d", &tabellone);
            }
            ...
            else if (decisione == 4)
            {
                ...
                printf("                                                   \n");
                printf("                                                   \n");
                stato(cellaAttuale, contoBancario, prices[cellaAttuale], numeroProprieta, numCase[cellaAttuale], proprieties[cellaAttuale]);
                printf("Digitare qualunque numero per tornare al tabellone\n");
                scanf("%d", &tabellone);
            }
            else
